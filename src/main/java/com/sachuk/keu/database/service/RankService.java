...
public class RankService {
    ...
    public Rank save(Rank rank) { return rankRepository.save(rank); }
    ...
    public Rank saveAndFlush(Rank rank) { return rankRepository.saveAndFlush(rank); }
    public void flush() {
        rankRepository.flush();
    }
    public void saveAll(Iterable<Rank> rank) { rankRepository.saveAll(rank); }
    public long count() {

...
public class DocumentGeneratorService {
    private final static String SAVED_FILE_DIRECTORY_PATH = "static/documents/generated_files";
    private final static String LOAD_FILE_DIRECTORY_PATH = "static/documents/documents_templates/Витяг_з_КЕУ.docx";

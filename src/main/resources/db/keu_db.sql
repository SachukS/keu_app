...
INSERT INTO `family_members` (`id`, `birth_date`, `name`, `surname`, `third_name`, `military_man_id`)
VALUES (1, '1990-10-09 00:00:00', 'Олександр', 'Іванов', 'Вікторович', 1),
       (2, '1995-10-09 00:00:00', 'Марина', 'Іванова', 'Вікторівна', 1);
...
(
    ...
    `garrison`         varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `users` (`id`, `accounting_place`, `birth_date`, `create_date`, `garrison`, `ipn`, `name`, `password`,
                     `sex`, `surname`, `thirdname`, `update_date`, `military_man_id`)
VALUES (1, 'ЖК ВІТІ', '1999-10-01 00:00:00', '2023-10-01 00:00:00', 'м. Київ', '1234567861', 'Борис', '12345678',
        'MALE', 'Петренко', 'Миколайович', '2022-07-21 15:45:16', NULL),
       (2, 'ЖК ВІКНУ', '1999-10-01 00:00:00', '2023-10-01 00:00:00', 'м. Київ', '1234567831', 'Артем', '12345678',
...
(
    ...
    `garrison`         varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `works` (`id`, `accounting_place`, `garrison`, `work_place`)
VALUES (1, 'ЖК КСВ', 'м.Київ', 'КСВ'),
       (2, 'КОб. Сил', 'м.Київ', 'А0135'),
       (3, 'ЖК КССО', 'м.Київ', 'А0987 вм №161'),
       (4, 'КВЗв\'язку', 'м.Київ', 'КВЗв\'язку'),
       (8, 'ЖК КМедСил', 'м.Київ', 'ГВКЦ'),
       (11, 'ЖК АМОУ та БПС', 'м.Київ', 'А0615 (126ЦЗРМ)'),
       (17, 'ЖК НУОУ', 'м.Київ', 'НУОУ'),
       (18, 'ЖК АМОУ та БПС', 'м.Київ', 'Ансамбль'),
       (19, 'ЖК ГШ ЗСУ', 'м.Київ', 'А2100  (ЦУВСП)'),
       (23, 'ЖК КСЛогістики', 'м.Київ', 'Комвійськсполуч'),
       (25, 'ЖК АМОУ та БПС', 'м.Київ', 'ВП'),
       (72, 'ЖК ККЕУ', 'м.Київ', 'В/Прокуратури'),
       (73, 'ЖК ГШ ЗСУ', 'м.Київ', 'ГУОП'),
       (74, 'ЖК КСВ', 'м.Київ', 'МВК'),
       (77, 'ЖК НУОУ', 'м.Київ', 'ЦВСД'),
       (78, 'ЖК ВIТI', 'м.Київ', 'ВІТІ ім.Г.Крут'),
       (79, 'ЖК КСЛогістики', 'м.Київ', 'КСЛогістики'),
       (84, 'ЖК КСВ', 'м.Київ', 'КВЛ ім.Богуна'),
       (85, 'ЖК ККЕУ', 'м.Київ', 'ККЕУ'),
       (88, 'ЖК КСВ', 'м.Київ', 'ОВК'),
       (89, 'ЖК АМОУ та БПС', 'м.Київ', 'Ред.\"Hар.армія\"'),
       (91, 'ЖК ГШ ЗСУ', 'м.Київ', ' ЦНДІ'),
       (92, 'ЖК КСПідтримки', 'м.Київ', 'А2330'),
       (93, 'ЖК АМОУ та БПС', 'м.Київ', 'ЦСК МОУ'),
       (94, 'ЖК ВIТI', 'м.Київ', 'в/к АМуніцУ'),
       (95, 'ЖК ККЕУ', 'м.Київ', 'в/м 161'),
       (96, 'ЖК ВIТI', 'м.Київ', 'в/к НТрУ'),
       (97, 'ЖК ВIКНУ', 'м.Київ', 'ВІКНУ'),
       (98, 'ЖК А0799', 'м.Київ', 'КВП НАУ'),
       (100, 'ЖК КМедСил', 'м.Київ', 'УВМедА'),
       (101, 'ЖК ВIТI', 'м.Київ', 'в/к НТУУ \"КПІ\"'),
       (102, 'ЖК ВIТI', 'м.Київ', 'в/к АДПС Укр'),
       (103, 'ЖК ВIТI', 'м.Київ', 'в/к НАгрУ'),
       (110, 'ЖК АМОУ та БПС', 'м.Київ', 'ЦСБУ'),
       (115, 'ЖК КСЛогістики', 'м.Київ', 'А0297'),
       (116, 'ЖК АМОУ та БПС', 'м.Київ', 'ЦПІ МОУ'),
       (121, 'ЖК КСЛогістики', 'м.Київ', 'А2788'),
       (123, 'ЖК КСВ', 'м.Київ', 'А0222'),
       (124, 'ЖК ККЕУ', 'м.Київ', '55127  (17ВА)'),
       (126, 'ЖК ККЕУ', 'м.Київ', 'А2215 (Борисп)'),
       (129, 'ЖК ККЕУ', 'м.Київ', 'А0138'),
       (130, 'ЖК А0799,А1236', 'м.Київ', 'А0799,А1236'),
       (131, 'ЖК КВЗв\'язку', 'м.Київ', 'А0168'),
       (132, 'ЖК ГШ ЗСУ', 'м.Київ', 'А3521'),
       (133, 'ЖК ГШ ЗСУ', 'м.Київ', 'ГУЛ'),
       (134, 'ЖК КВЗв\'язку', 'м.Київ', 'А0106'),
       (135, 'ЖК КВЗв\'язку', 'м.Київ', 'А0334'),
       (136, 'ЖК КВЗв\'язку', 'м.Київ', 'А0476'),
       (137, 'ЖК ГШ ЗСУ', 'м.Київ', 'А0488'),
       (138, 'ЖК ГШ ЗСУ', 'м.Київ', 'ЦУБезп.'),
       (140, 'ЖК КСВ', 'м.Київ', 'А2788'),
       (143, 'ЖК КСЛогістики', 'м.Київ', 'А2070'),
       (148, 'ЖК КМедСил', 'м.Київ', 'А1200(Ірпінь)'),
       (151, 'ЖК ККЕУ', 'м.Київ', 'А2405 (розф)'),
       (153, 'ЖК Озброєння', 'м.Київ', 'А0294'),
       (154, 'ЖК АМОУ та БПС', 'м.Київ', 'Військо України'),
       (155, 'ЖК А0515 i ПВЧ', 'м.Київ', 'А0515'),
       (157, 'ЖК ККЕУ', 'м.Київ', 'А2161'),
       (160, 'ЖК ККЕУ', 'м.Київ', 'А3918 (розф)'),
       (164, 'ЖК ККЕУ', 'м.Київ', 'А1811 (розф)'),
       (165, 'ЖК ККЕУ', 'м.Київ', 'п.37'),
       (170, 'ЖК Озброєння', 'м.Київ', 'А2788'),
       (174, 'ЖК АМОУ та БПС', 'м.Київ', 'ГУМР'),
       (175, 'ЖК ГШ ЗСУ', 'м.Київ', 'А0565'),
       (176, 'ЖК АМОУ та БПС', 'м.Київ', 'А4566'),
       (178, 'ЖК ККЕУ', 'м.Київ', 'А0324(розф)'),
       (179, 'ЖК АМОУ та БПС', 'м.Київ', 'МОУ'),
       (180, 'ЖК КСЛогістики', 'м.Київ', 'Озброєння'),
       (181, 'ЖК ГШ ЗСУ', 'м.Київ', 'ГШ ЗСУ'),
       (182, 'ЖК ГШ ЗСУ', 'м.Київ', 'ООК ЗСУ'),
       (184, 'ЖК ГШ ЗСУ', 'м.Київ', 'А0139'),
       (185, 'ЖК КВЗв\'язку', 'м.Київ', 'А0351'),
       (186, 'ЖК АМОУ та БПС', 'м.Київ', 'ЦЗСД МОУ'),
       (187, 'ЖК ГШ ЗСУ', 'м.Київ', 'А0136'),
       (188, 'ЖК КОб.Сил', 'м.Київ', 'А0135'),
       (189, 'ЖК КМедСил', 'м.Київ', 'КМедСил'),
       (190, 'ЖК КСПідтримки', 'м.Київ', 'А0602'),
       (191, 'ЖК КСПідтримки', 'м.Київ', 'А0204'),
       (192, 'ЖК КСПідтримки', 'м.Київ', 'А1423'),
       (193, 'ЖК КСПідтримки', 'м.Київ', 'А1333'),
       (194, 'ЖК КСПідтримки', 'м.Київ', 'РАЦ'),
       (195, 'КСЛогістики', 'м.Київ', 'ЦУІІЗ'),
       (196, 'Всі', 'м.Київ', 'Всі'),
       (197, 'ЖК КСВ', 'м.Київ', 'A0105'),
       (201, 'в/ч А1789', 'Василькiв', 'в/ч А1789'),
       (202, 'в/ч А0704', 'Василькiв', 'в/ч А0704'),
       (203, 'в/ч А2682', 'Василькiв', 'в/ч А2682'),
       (204, 'в/ч А1880', 'Василькiв', 'в/ч А1880'),
       (206, 'в/ч А2860', 'Василькiв', 'в/ч А2860'),
       (209, 'Обухівський РТЦК', 'Василькiв', 'Обухівський РТЦК'),
       (210, 'А-0820', 'Василькiв', 'А-0820'),
       (211, 'Iрпiн.Буч.ОМВК', 'Гостомель', 'Ірпін.Буч.ОМВК'),
       (213, 'НУОУ', 'Переяславський', 'НУОУ'),
       (214, 'А-0294', 'Василькiв', 'А-0294'),
       (217, 'ОРВК', 'Василькiв', 'ОРВК'),
       (218, 'в/ч А-0952', 'Василькiв', 'в/ч А-0952'),
       (219, 'в/ч А-0565', 'Гостомель', 'в/ч А-0565'),
       (221, 'в/ч А-2923', 'Гостомель', 'в/ч А-2923'),
       (222, 'в/ч А-4180', 'Гостомель', 'в/ч А-4180'),
       (223, 'Вишгород РВК', 'Гостомель', 'Вишгород РВК'),
       (224, 'ФВП   НАДПС', 'Гостомель', 'ФВП   НАДПС'),
       (225, 'в/ч А-2206', 'Бровари', 'в/ч А-2206'),
       (227, 'А-0706', 'Семиполки', 'А-0706'),
       (229, 'А-0415', 'Семиполки', 'А-0415'),
       (232, 'А-1525', 'Семиполки', 'А-1525'),
       (233, 'в/ч А-3085', 'Переяславський', 'в/ч А-3085'),
       (241, 'в/ч А-2860 Б', 'Бровари', 'в/ч А-2860 Б'),
       (243, 'в/ч А-2299', 'Бровари', 'в/ч А-2299'),
       (244, 'ОМВК Бровари', 'Бровари', 'ОМВК Бровари'),
       (245, 'в/ч А-0799 Б', 'Бровари', 'в/ч А-0799 Б'),
       (248, 'в/ч А-2215', 'Бориспiль', 'в/ч А-2215'),
       (249, 'ОМВК Бориспiль', 'Бориспiль', 'ОМВК Бориспіль'),
       (256, 'НОК КВЛ', 'Василькiв', 'НОК КВЛ'),
       (259, 'в/ч А-0766', 'Бровари', 'в/ч А-0766'),
       (261, 'Бородян.РВК', 'Гостомель', 'Бородян.РВК'),
       (262, 'в/ч  А2860 Г', 'Гостомель', 'в/ч  А2860 Г'),
       (263, 'А-3796', 'Гостомель', 'А-3796'),
       (268, 'в/ч А2206 №3', 'Гостомель', 'в/ч А2206 №3'),
       (269, 'в/ч А3723', 'Гостомель', 'в/ч А3723'),
       (270, 'в/ч А2860 С', 'Семиполки', 'в/ч А2860 С'),
       (271, 'в/ч А0525', 'Бровари', 'в/ч А0525'),
       (272, 'Iван. ОРВК', 'Гостомель', 'Іван. ОРВК'),
       (282, 'А2399', 'Переяславський', 'А2399');
